...
// ==========================================
// 强制登录（如果还没登录，自动以 admin 登录）
// ==========================================
$OJ_NAME = isset($OJ_NAME) ? $OJ_NAME : 'HUSTOJ';
if (!isset($_SESSION[$OJ_NAME . '_' . 'user_id'])) {
    $_SESSION[$OJ_NAME . '_' . 'user_id'] = 'admin';
    $_SESSION[$OJ_NAME . '_' . 'administrator'] = true;
    $_SESSION[$OJ_NAME . '_' . 'nick'] = 'Administrator';
...
if ($login) {
    // ==========================================
    // 修复：session_regenerate_id 前检查 session
    // ==========================================
    if (session_status() == PHP_SESSION_NONE) {
        session_start();
    }
